...
por ele no mês (em dinheiro). Sabendo que este vendedor ganha 15% de comissão sobre suas vendas efetuadas, informar o total a receber no final do mês, com duas casas decimais.
...
let nomeDeUmVendedor = "JOAO";
let salarioFixo = 500.00;
let totalDeVendasEfetuadasPorEle = 1230.30;
let TOTAL = salarioFixo +  (totalDeVendasEfetuadasPorEle * 0.15);
